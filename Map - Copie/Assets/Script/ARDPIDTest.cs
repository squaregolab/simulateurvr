...
public class ARDPIDTest : MonoBehaviour {

	public static ARDPIDTest Instance;
	public string RiData;
		...
		try
		{
			if (SerialPort.IsOpen)
			{
				...
				if (rData != null && rData != "")
				{
					...
					if (rData.IndexOf('L') == 0)
					{
						int R = rData.IndexOf('R');
						LeData = rData.Substring(1,R-1);
						RiData = rData.Substring(R+1,rData.Length-LeData.Length-2);
					}
